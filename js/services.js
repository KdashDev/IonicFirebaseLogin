...
.factory('FirebaseDB', function ($q, $state, $timeout) {
  ...
  var config = {
    apiKey: "AIzaSyClD73T50GZbkyIfL6vflUOnw-blHH8esU",
    authDomain: "ciberguia-firebase.firebaseapp.com",
    databaseURL: "https://ciberguia-firebase.firebaseio.com",
    projectId: "ciberguia-firebase",
    storageBucket: "ciberguia-firebase.appspot.com",
    messagingSenderId: "451359614531"
  };
